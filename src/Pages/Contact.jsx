    ...
    <>
      <section className="py-12 md:py-20 xl:py-32">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-center">
            <div className="w-full md:w-10/12 lg:w-8/12 xl:w-7/12 2xl:w-6/12 text-center">
              <h2 className="mb-4 text-5xl font-bold text-[#214fc6] max-sm:text-3xl">
                CONTACT WITH US
              </h2>
                    ...
                    <div className="flex flex-col items-center justify-center h-full p-8">
                      <div className="text-center lg:text-left">
                        ...
                        <p className="text-lg text-gray-700 mb-8">
                          ...
                          If you're interested in working with us, please get in
                        ...
                        <div className="flex mb-8">
                          ...
                          <div>
                            ...
                            <address className="text-gray-700">
                              2, Block A, Loni Industrial Area, Ghaziabad, Uttar
                              Pradesh 201007
                            </address>
                          </div>
                        </div>
                            ...
                            <div className="flex mb-0">
                              ...
                              <div>
                                ...
                                <p className="mb-0">
                                  <Link
                                    className="text-gray-700 hover:text-gray-900"
                                    to="mailto:pardeep@jpsengineers.com"
                                  >
                                    pardeep@jpsengineers.com
                                  </Link>
                                </p>
                                <p className="mb-0">
                                  <Link
                                    className="text-gray-700 hover:text-gray-900"
                                    to="mailto:sales@jpsengineers.com"
                                  >
                                    sales@jpsengineers.com
                                  </Link>
                                </p>
                              </div>
                            </div>
        ...
        <div className="container mt-12 mx-auto">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3500.096867879083!2d77.37720517934567!3d28.686748799999993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cf157e7a35903%3A0x2095032024522f5!2z4KSc4KWHIOCkquClgCDgpI_gpLgg4KSH4KSo4KWN4KSc4KWA4KSo4KS_4KSv4KSw4KWN4KS4!5e0!3m2!1shi!2sin!4v1722408947357!5m2!1shi!2sin"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen=""
